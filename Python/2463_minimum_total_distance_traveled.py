# -*- coding: utf-8 -*-
"""2463. Minimum Total Distance Traveled.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LWDNAfubFFkXUSPIn3JtGeBBiTnL-tXg
"""
...
class Solution:
    def minimumTotalDistance(self, robot: List[int], factory: List[List[int]]) -> int:
        # Sort robots and factories by position to minimize distance during pairing
        robot.sort()
        factory.sort()
